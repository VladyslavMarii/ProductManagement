...
public class Shop {
    public static void main(String[] args) {
        ...
        p2 = pm.reviewProduct(p2, Rating.ONE_STAR, "Bad arabica coffee");
        p2 = pm.reviewProduct(p2, Rating.FIVE_STAR, "Best with a lot of sugar");
        ...
        p6 = pm.reviewProduct(p6, Rating.THREE_STAR, "Eatable");
